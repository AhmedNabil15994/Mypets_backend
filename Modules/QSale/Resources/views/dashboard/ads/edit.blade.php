  ...
  <div class="page-content">
    ...
    <div class="row">
      <form id="updateForm"
        ...
        action="{{route('dashboard.ads.update',$model->id)}}">
        @csrf
        @method('PUT')
        <div class="col-md-12">
                ...
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="checkbox"
                        class="make-switch"
                        @if($model->hide_private_number) checked @endif value="1" id="hide_private_number" data-size="small" name="hide_private_number">
                      <div class="help-block"></div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      <span class="holder"
                        ...
                        <img src="{{optional($model->getFirstMedia("
                          default_image"))->getUrl()}}" style="height: 15rem;">
                      </span>
                      <input type="hidden"
                        data-name="image">
                      <div class="help-block"></div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <select class="form-control select2"
                        ...
                        <option value="{{$status}}"
                          {{$model->status == $status ? "selected" : ""}} >{{$status}}</option>
                        @endif
                        @endforeach
                      </select>
                      <div class="help-block"></div>
                ...
                <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="checkbox"
                        class="make-switch"
                        @if($model->is_paid) checked @endif value="1" id="" data-size="small" name="is_paid">
                      <div class="help-block"></div>
                    </div>
                  </div>
                  @endif
                  ...
                  <div class="row group_address">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select name="address[0][state_id]"
                            id="state"
                            disabled
                            data-current=""
                            class="form-control state-address">
            ...
            <div class="row group_address">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select name="address[:id_stub][city_id]"
                      disabled
                      data-current=""
                      class="form-control city-address">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <select name="address[:id_stub][state_id]"
                      disabled
                      data-current=""
                      class="form-control state-address">
