                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea type="text" name="description" rows="8" cols="80" class="form-control " data-name="description"></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane  fade in" id="user">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="user_id" class="form-control " style="width: 100%;" data-name="user_id">
                                                @foreach ($users->User()->get() as $user )
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" min="0" class="form-control" cldata-size="small" value="{{setting('other', 'default_price') ?? 0}}" name="ads_price" >
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            {{-- END CREATE FORM --}}
                              ...
                              <div class="tab-pane fade in" id="categories">
                                ...
                                <div  class="user jstree">
                                    ...
                                    @include('qsale::dashboard.tree.ads.view',['mainCategories' => $normalCategories])
                                </div>
